...
# Handle torchvision weights API across versions
try:
    from torchvision.models import ResNet18_Weights, ResNet50_Weights
    _RESNET18_WEIGHTS = ResNet18_Weights.IMAGENET1K_V1
    _RESNET50_WEIGHTS = ResNet50_Weights.IMAGENET1K_V1
except Exception:  # fallback for older/newer APIs
    _RESNET18_WEIGHTS = "IMAGENET1K_V1"
    _RESNET50_WEIGHTS = "IMAGENET1K_V1"
...
def resnet18(pretrained=True, **kwargs):
    ...
    if pretrained:
        tv_model = tv_resnet.resnet18(weights=_RESNET18_WEIGHTS)
...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        tv_model = tv_resnet.resnet50(weights=_RESNET50_WEIGHTS)
        model.load_state_dict(tv_model.state_dict(), strict=False)
    return model
